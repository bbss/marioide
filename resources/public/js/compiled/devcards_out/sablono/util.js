...
var x__44572__auto__ = (((x == null))?null:x);
var m__44573__auto__ = (sablono.util.to_str[goog.typeOf(x__44572__auto__)]);
if(!((m__44573__auto__ == null))){
return m__44573__auto__.call(null,x);
} else {
var m__44573__auto____$1 = (sablono.util.to_str["_"]);
if(!((m__44573__auto____$1 == null))){
return m__44573__auto____$1.call(null,x);
} else {
...
var x__44572__auto__ = (((x == null))?null:x);
var m__44573__auto__ = (sablono.util.to_uri[goog.typeOf(x__44572__auto__)]);
if(!((m__44573__auto__ == null))){
return m__44573__auto__.call(null,x);
} else {
var m__44573__auto____$1 = (sablono.util.to_uri["_"]);
if(!((m__44573__auto____$1 == null))){
return m__44573__auto____$1.call(null,x);
} else {
...
var len__44984__auto___50731 = arguments.length;
var i__44985__auto___50732 = (0);
while(true){
if((i__44985__auto___50732 < len__44984__auto___50731)){
args__44991__auto__.push((arguments[i__44985__auto___50732]));

var G__50733 = (i__44985__auto___50732 + (1));
i__44985__auto___50732 = G__50733;
continue;
} else {
}
break;
...
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(argseq__44992__auto__);
});
...
sablono.util.as_str.cljs$lang$applyTo = (function (seq50730){
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq50730));
});
...
var vec__50737 = clojure.string.split.call(null,cljs.core.name.call(null,k),/-/);
var seq__50738 = cljs.core.seq.call(null,vec__50737);
var first__50739 = cljs.core.first.call(null,seq__50738);
var seq__50738__$1 = cljs.core.next.call(null,seq__50738);
var first_word = first__50739;
var words = seq__50738__$1;
...
var G__50741 = clojure.set.rename_keys.call(null,m,kmap);
if(cljs.core.map_QMARK_.call(null,new cljs.core.Keyword(null,"style","style",-496642736).cljs$core$IFn$_invoke$arity$1(m))){
return cljs.core.update_in.call(null,G__50741,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"style","style",-496642736)], null),sablono$util$camel_case_keys);
} else {
return G__50741;
}
} else {
...
return clojure.string.join.call(null," ",cljs.core.flatten.call(null,cljs.core.map.call(null,(function (p1__50742_SHARP_){
if(typeof p1__50742_SHARP_ === 'string'){
return p1__50742_SHARP_;
} else {
return cljs.core.seq.call(null,p1__50742_SHARP_);
...
var x__$1 = this;
if(cljs.core.truth_((function (){var or__43909__auto__ = x__$1.hasDomain();
...
//# sourceMappingURL=util.js.map?rel=1476618790249