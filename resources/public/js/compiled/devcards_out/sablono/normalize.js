...
if(((cljs.core.set_QMARK_.call(null,class$__$1)) || (cljs.core.sequential_QMARK_.call(null,class$__$1))) && (cljs.core.every_QMARK_.call(null,(function (p1__50745_SHARP_){
return ((p1__50745_SHARP_ instanceof cljs.core.Keyword)) || (typeof p1__50745_SHARP_ === 'string');
}),class$__$1))){
...
return cljs.core.update_in.call(null,G__50747,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"class","class",-2030961996)], null),sablono.normalize.class$);
} else {
return G__50747;
}
});
...
var len__44984__auto___50750 = arguments.length;
var i__44985__auto___50751 = (0);
while(true){
if((i__44985__auto___50751 < len__44984__auto___50750)){
args__44991__auto__.push((arguments[i__44985__auto___50751]));

var G__50752 = (i__44985__auto___50751 + (1));
i__44985__auto___50751 = G__50752;
continue;
} else {
}
break;
...
return sablono.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(argseq__44992__auto__);
});
...
var G__50749 = cljs.core.apply.call(null,cljs.core.merge,maps__$1);
if(!(cljs.core.empty_QMARK_.call(null,classes__$1))){
return cljs.core.assoc.call(null,G__50749,new cljs.core.Keyword(null,"class","class",-2030961996),classes__$1);
} else {
return G__50749;
}
});
...
sablono.normalize.merge_with_class.cljs$lang$applyTo = (function (seq50748){
return sablono.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq50748));
});
...
var vec__50758 = ((cljs.core.empty_QMARK_.call(null,matches))?(function(){throw cljs.core.ex_info.call(null,[cljs.core.str("Can't match CSS tag: "),cljs.core.str(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null).call(null,cljs.core.ffirst.call(null,matches)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["div",matches], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first.call(null,matches),cljs.core.rest.call(null,matches)], null)
));
var tag_name = cljs.core.nth.call(null,vec__50758,(0),null);
var names = cljs.core.nth.call(null,vec__50758,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,cljs.core.first.call(null,cljs.core.map.call(null,sablono.normalize.strip_css,cljs.core.filter.call(null,((function (matches,vec__50758,tag_name,names){
return (function (p1__50753_SHARP_){
return cljs.core._EQ_.call(null,"#",cljs.core.first.call(null,p1__50753_SHARP_));
});})(matches,vec__50758,tag_name,names))
,names))),cljs.core.vec.call(null,cljs.core.map.call(null,sablono.normalize.strip_css,cljs.core.filter.call(null,((function (matches,vec__50758,tag_name,names){
return (function (p1__50754_SHARP_){
return cljs.core._EQ_.call(null,".",cljs.core.first.call(null,p1__50754_SHARP_));
});})(matches,vec__50758,tag_name,names))
,names)))], null);
});
/**
 ...
 */
sablono.normalize.element = (function sablono$normalize$element(p__50761){
var vec__50768 = p__50761;
var seq__50769 = cljs.core.seq.call(null,vec__50768);
var first__50770 = cljs.core.first.call(null,seq__50769);
var seq__50769__$1 = cljs.core.next.call(null,seq__50769);
var tag = first__50770;
var content = seq__50769__$1;
...
var vec__50771 = sablono.normalize.match_tag.call(null,tag);
var tag__$1 = cljs.core.nth.call(null,vec__50771,(0),null);
var id = cljs.core.nth.call(null,vec__50771,(1),null);
var class$ = cljs.core.nth.call(null,vec__50771,(2),null);
...
//# sourceMappingURL=normalize.js.map?rel=1476618790302