...
var o__62406__auto__ = (function (){var temp__4657__auto__ = goog.object.get(window,"cljs");
if(cljs.core.truth_(temp__4657__auto__)){
var o__62418__auto__ = temp__4657__auto__;
return goog.object.get(o__62418__auto__,"core");
} else {
return null;
}
})();
return goog.object.get(o__62406__auto__,"js_reserved_QMARK_").call(o__62406__auto__,x);
});
devtools.munging.get_fn_source_safely = (function devtools$munging$get_fn_source_safely(f){
try{var o__62406__auto__ = f;
return goog.object.get(o__62406__auto__,"toString").call(o__62406__auto__);
}catch (e63067){var _ = e63067;
return "";
}});
...
try{var o__62406__auto___63070 = t;
goog.object.get(o__62406__auto___63070,"cljs$lang$ctorPrWriter").call(o__62406__auto___63070,t,writer);
}catch (e63069){var __63071 = e63069;
}
...
var char_code = (function (){var o__62406__auto__ = (new String(char$));
return goog.object.get(o__62406__auto__,"charCodeAt").call(o__62406__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__62406__auto__ = String;
return goog.object.get(o__62406__auto__,"fromCharCode").call(o__62406__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__63073 = num_code;
switch (G__63073) {
case (1):
return (185);
...
var o__62406__auto__ = String;
return goog.object.get(o__62406__auto__,"fromCharCode").call(o__62406__auto__,superscript_code);
});
/**
...
}catch (e63079){var e__62431__auto__ = e63079;
return false;
}})())){
...
var vec__63080 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__63080,(0),null);
...
var or__44234__auto__ = (function (){var temp__4655__auto__ = cljs.core.re_matches.call(null,/(.*)\$/,s);
if(cljs.core.truth_(temp__4655__auto__)){
...
var temp__4657__auto____$1 = goog.object.get(o__62419__auto__,"dependencies_");
if(cljs.core.truth_(temp__4657__auto____$1)){
var o__62418__auto__ = temp__4657__auto____$1;
return goog.object.get(o__62418__auto__,"nameToPath");
} else {
return null;
}
} else {
...
var len__45309__auto___63089 = arguments.length;
var i__45310__auto___63090 = (0);
while(true){
if((i__45310__auto___63090 < len__45309__auto___63089)){
args__45316__auto__.push((arguments[i__45310__auto___63090]));

var G__63091 = (i__45310__auto___63090 + (1));
i__45310__auto___63090 = G__63091;
continue;
} else {
}
break;
...
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__45317__auto__);
});

devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__63085){
var vec__63086 = p__63085;
var ns_detector = cljs.core.nth.call(null,vec__63086,(0),null);
var effective_detector = (function (){var or__44234__auto__ = ns_detector;
if(cljs.core.truth_(or__44234__auto__)){
return or__44234__auto__;
} else {
...
var G__63092 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__63093 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__63092;
remaining_tokens = G__63093;
continue;
}
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq63083){
var G__63084 = cljs.core.first.call(null,seq63083);
var seq63083__$1 = cljs.core.next.call(null,seq63083);
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(G__63084,seq63083__$1);
});
...
break;
default:
var o__62406__auto__ = window;
return goog.object.get(o__62406__auto__,"parseInt").call(o__62406__auto__,arity,(10));
...
var vec__63101 = cljs.core.split_with.call(null,(function (p1__63097_SHARP_){
return cljs.core.not_EQ_.call(null,p1__63097_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__63101,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__63101,(1),null);
...
var vec__63107 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__63107,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__63107,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__63110 = cljs.core.rest.call(null,remaining_tokens);
var G__63111 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__63110;
name_tokens = G__63111;
continue;
} else {
...
var args63112 = [];
var len__45309__auto___63124 = arguments.length;
var i__45310__auto___63125 = (0);
while(true){
if((i__45310__auto___63125 < len__45309__auto___63124)){
args63112.push((arguments[i__45310__auto___63125]));

var G__63126 = (i__45310__auto___63125 + (1));
i__45310__auto___63125 = G__63126;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args63112.length)].join('')));
...
var vec__63115 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__63115,(0),null);
var arity = cljs.core.nth.call(null,vec__63115,(1),null);
var vec__63118 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__63118,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__63118,(1),null);
var vec__63121 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__63121,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__63121,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__63121,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__63121,(3),null);
...
var args63128 = [];
var len__45309__auto___63134 = arguments.length;
var i__45310__auto___63135 = (0);
while(true){
if((i__45310__auto___63135 < len__45309__auto___63134)){
args63128.push((arguments[i__45310__auto___63135]));

var G__63136 = (i__45310__auto___63135 + (1));
i__45310__auto___63135 = G__63136;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args63128.length)].join('')));
...
var vec__63131 = result;
var munged_ns = cljs.core.nth.call(null,vec__63131,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__63131,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__63131,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__63131,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__63131,(4),null);
var arity = cljs.core.nth.call(null,vec__63131,(5),null);
...
if(cljs.core.truth_(temp__4655__auto__)){
var vec__63144 = temp__4655__auto__;
var munged_name = cljs.core.nth.call(null,vec__63144,(0),null);
var args = cljs.core.nth.call(null,vec__63144,(1),null);
var vec__63147 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__63147,(0),null);
var name = cljs.core.nth.call(null,vec__63147,(1),null);
...
var G__63150 = (arity + (1));
var G__63151 = (function (){var temp__4655__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__4655__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__63152){
var vec__63156 = p__63152;
var arity = cljs.core.nth.call(null,vec__63156,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__63156,(1),null);
...
var fixed_arities = devtools.munging.collect_fn_fixed_arities.call(null,f,(function (){var or__44234__auto__ = max_fixed_arity;
if(cljs.core.truth_(or__44234__auto__)){
return or__44234__auto__;
} else {
...
return (function (p1__63159_SHARP_){
return cljs.core.get.call(null,arities,p1__63159_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return (function (p1__63160_SHARP_){
return cljs.core.drop.call(null,(2),p1__63160_SHARP_);
...
var args__45316__auto__ = [];
var len__45309__auto___63167 = arguments.length;
var i__45310__auto___63168 = (0);
while(true){
if((i__45310__auto___63168 < len__45309__auto___63167)){
args__45316__auto__.push((arguments[i__45310__auto___63168]));

var G__63169 = (i__45310__auto___63168 + (1));
i__45310__auto___63168 = G__63169;
continue;
} else {
}
break;
...
var argseq__45317__auto__ = ((((1) < args__45316__auto__.length))?(new cljs.core.IndexedSeq(args__45316__auto__.slice((1)),(0),null)):null);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__45317__auto__);
});

devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__63163){
var vec__63164 = p__63163;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__63164,(0),null);
...
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq63161){
var G__63162 = cljs.core.first.call(null,seq63161);
var seq63161__$1 = cljs.core.next.call(null,seq63161);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic(G__63162,seq63161__$1);
});
...
var G__63171 = (((arg instanceof cljs.core.Keyword))?arg.fqn:null);
switch (G__63171) {
...
return devtools.munging.args_lists_to_strings.call(null,devtools.munging.arities_to_args_lists.call(null,(function (){var or__44234__auto__ = devtools.munging.collect_fn_arities.call(null,f);
if(cljs.core.truth_(or__44234__auto__)){
return or__44234__auto__;
} else {
...
return [cljs.core.str((cljs.core.truth_((function (){var and__44222__auto__ = include_ns_QMARK_;
...
return [cljs.core.str((cljs.core.truth_(include_protocol_ns_QMARK_)?protocol_ns:null)),cljs.core.str(((!(cljs.core.empty_QMARK_.call(null,protocol_name)))?[cljs.core.str((cljs.core.truth_(include_protocol_ns_QMARK_)?".":null)),cljs.core.str(protocol_name)].join(''):null)),cljs.core.str(((!(cljs.core.empty_QMARK_.call(null,protocol_method)))?[cljs.core.str((cljs.core.truth_((function (){var or__44234__auto__ = include_protocol_ns_QMARK_;
if(cljs.core.truth_(or__44234__auto__)){
return or__44234__auto__;
} else {
...
var map__63178 = options;
var map__63178__$1 = ((((!((map__63178 == null)))?((((map__63178.cljs$lang$protocol_mask$partition0$ & (64))) || (map__63178.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__63178):map__63178);
var include_ns_QMARK_ = cljs.core.get.call(null,map__63178__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__63178__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__63178__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__63178__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__63179 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__63179,(0),null);
var fn_name = cljs.core.nth.call(null,vec__63179,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__63179,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__63179,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__63179,(4),null);
var arity = cljs.core.nth.call(null,vec__63179,(5),null);
...
var protocol_part = (cljs.core.truth_((function (){var and__44222__auto__ = protocol_ns;
if(cljs.core.truth_(and__44222__auto__)){
return cljs.core.not.call(null,(function (){var and__44222__auto____$1 = silence_common_protocols_QMARK_;
...
return [cljs.core.str((function (){var or__44234__auto__ = protocol_part;
if(cljs.core.truth_(or__44234__auto__)){
return or__44234__auto__;
} else {
return fn_part;
...
var o__62406__auto__ = f;
return goog.object.get(o__62406__auto__,"getBasis").call(o__62406__auto__);
});
/**
...
if(cljs.core.truth_((function (){var and__44222__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__44222__auto__)){
...
}catch (e63184){var e__62431__auto__ = e63184;
...
var G__63185 = goog.object.get(obj,cljs.core.first.call(null,path));
var G__63186 = cljs.core.rest.call(null,path);
obj = G__63185;
path = G__63186;
continue;
} else {
...
var partition_bits = (function (){var or__44234__auto__ = goog.object.get(obj,partition_key);
if(cljs.core.truth_(or__44234__auto__)){
return or__44234__auto__;
} else {
return (0);
...
return (function (accum,p__63191){
var vec__63192 = p__63191;
var bit = cljs.core.nth.call(null,vec__63192,(0),null);
var protocol = cljs.core.nth.call(null,vec__63192,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__63195){
var vec__63199 = p__63195;
var ns = cljs.core.nth.call(null,vec__63199,(0),null);
var name = cljs.core.nth.call(null,vec__63199,(1),null);
var selector = cljs.core.nth.call(null,vec__63199,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__63208,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__63208,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__63208,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__63202_SHARP_){
return goog.object.get(obj,cljs.core.first.call(null,p1__63202_SHARP_));
});})(name,sorted_matches,vec__63208,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1476719766191