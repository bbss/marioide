...
var o__62406__auto___63651 = (function (){var o__62406__auto__ = (function (){var o__62406__auto__ = Promise;
return goog.object.get(o__62406__auto__,"resolve").call(o__62406__auto__);
})();
return goog.object.get(o__62406__auto__,"then").call(o__62406__auto__,callback);
})();
goog.object.get(o__62406__auto___63651,"catch").call(o__62406__auto___63651,devtools.async.rethrow_outside_promise);
...
var G__63653_63654 = Error;
var target__62425__auto___63655 = G__63653_63654;
if(cljs.core.truth_(target__62425__auto___63655)){
} else {
throw (new Error([cljs.core.str("Assert failed: "),cljs.core.str([cljs.core.str("unable to locate object path "),cljs.core.str(null),cljs.core.str(" in "),cljs.core.str(G__63653_63654)].join('')),cljs.core.str("\n"),cljs.core.str("target__62425__auto__")].join('')));
}

goog.object.set(target__62425__auto___63655,cljs.core.last.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["stackTraceLimit"], null)),Infinity);
...
//# sourceMappingURL=async.js.map?rel=1476719767118