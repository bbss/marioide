...
var len__45309__auto___63254 = arguments.length;
var i__45310__auto___63255 = (0);
while(true){
if((i__45310__auto___63255 < len__45309__auto___63254)){
args__45316__auto__.push((arguments[i__45310__auto___63255]));

var G__63256 = (i__45310__auto___63255 + (1));
i__45310__auto___63255 = G__63256;
continue;
} else {
}
break;
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__45317__auto__);
});
...
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq63251){
var G__63252 = cljs.core.first.call(null,seq63251);
var seq63251__$1 = cljs.core.next.call(null,seq63251);
var G__63253 = cljs.core.first.call(null,seq63251__$1);
var seq63251__$2 = cljs.core.next.call(null,seq63251__$1);
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic(G__63252,G__63253,seq63251__$2);
});
...
if(cljs.core.truth_((function (){var or__44234__auto__ = devtools.formatters.helpers.directly_printable_QMARK_.call(null,value);
...
devtools.formatters.printing.TemplateWriter.cljs$lang$ctorPrWriter = (function (this__44840__auto__,writer__44841__auto__,opt__44842__auto__){
return cljs.core._write.call(null,writer__44841__auto__,"devtools.formatters.printing/TemplateWriter");
});
...
if(cljs.core.truth_((function (){var and__44222__auto__ = cljs.core.not.call(null,devtools.formatters.printing.already_reference_QMARK_.call(null,group));
if(and__44222__auto__){
var or__44234__auto__ = devtools.formatters.helpers.expandable_QMARK_.call(null,obj);
if(cljs.core.truth_(or__44234__auto__)){
return or__44234__auto__;
} else {
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__63257_SHARP_){
return cljs.core.some_QMARK_.call(null,cljs.core.meta.call(null,p1__63257_SHARP_));
})))){
...
var map__63266 = opts;
var map__63266__$1 = ((((!((map__63266 == null)))?((((map__63266.cljs$lang$protocol_mask$partition0$ & (64))) || (map__63266.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__63266):map__63266);
var markup_db = cljs.core.get.call(null,map__63266__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
if(cljs.core.truth_((function (){var or__44234__auto__ = (function (){try{if(!((obj == null))){
...
}catch (e63270){var e__62431__auto__ = e63270;
return false;
}})();
if(cljs.core.truth_(or__44234__auto__)){
return or__44234__auto__;
...
}catch (e63272){var e__62431__auto__ = e63272;
return false;
}}
})())){
...
var _STAR_current_state_STAR_63277 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__63278 = opts;
var map__63278__$1 = ((((!((map__63278 == null)))?((((map__63278.cljs$lang$protocol_mask$partition0$ & (64))) || (map__63278.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__63278):map__63278);
var markup_db = cljs.core.get.call(null,map__63278__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_63277;
}});
...
;
var temp__4655__auto___63283 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__4655__auto___63283)){
var managed_print_level_63284 = temp__4655__auto___63283;
var _STAR_print_level_STAR_63282_63285 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_63284;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_63282_63285,managed_print_level_63284,temp__4655__auto___63283,writer,opts,job_fn){
return (function (p1__63280_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__63280_SHARP_,null);
});})(_STAR_print_level_STAR_63282_63285,managed_print_level_63284,temp__4655__auto___63283,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_63282_63285;
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1476719766439