...
var G__63213 = devtools.prefs.pref.call(null,v);
v = G__63213;
continue;
} else {
return v;
...
var and__44222__auto__ = cljs.core.not.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"disable-cljs-fn-formatting","disable-cljs-fn-formatting",1903786837)));
if(and__44222__auto__){
var and__44222__auto____$1 = !(cljs.core.var_QMARK_.call(null,value));
if(and__44222__auto____$1){
...
var or__44234__auto__ = (function (){try{if(!((value == null))){
...
}catch (e63226){var e__62431__auto__ = e63226;
return false;
}})();
if(cljs.core.truth_(or__44234__auto__)){
return or__44234__auto__;
} else {
var or__44234__auto____$1 = (function (){try{if(!((value == null))){
...
}catch (e63230){var e__62431__auto__ = e63230;
return false;
}})();
...
}catch (e63232){var e__62431__auto__ = e63232;
return false;
}}
}
});
devtools.formatters.helpers.cljs_type_QMARK_ = (function devtools$formatters$helpers$cljs_type_QMARK_(f){
var and__44222__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__44222__auto__)){
var and__44222__auto____$1 = cljs.core.not.call(null,devtools.formatters.helpers.is_prototype_QMARK_.call(null,f));
if(and__44222__auto____$1){
...
var and__44222__auto__ = goog.isObject(value);
if(cljs.core.truth_(and__44222__auto__)){
...
var or__44234__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(or__44234__auto__)){
return or__44234__auto__;
} else {
...
var and__44222__auto__ = (function (){var or__44234__auto__ = devtools.formatters.helpers.cljs_land_value_QMARK_.call(null,value);
if(cljs.core.truth_(or__44234__auto__)){
return or__44234__auto__;
} else {
...
var vec__63237 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__63237,(0),null);
var name = cljs.core.nth.call(null,vec__63237,(1),null);
...
var and__44222__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(and__44222__auto__)){
...
var or__44234__auto__ = typeof value === 'string';
if(or__44234__auto__){
return or__44234__auto__;
} else {
var or__44234__auto____$1 = typeof value === 'number';
if(or__44234__auto____$1){
return or__44234__auto____$1;
} else {
...
return cljs.core.some.call(null,(function (p1__63240_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__63240_SHARP_);
}),template);
});
...
//# sourceMappingURL=helpers.js.map?rel=1476719766293