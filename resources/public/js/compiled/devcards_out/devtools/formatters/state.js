...
var len__45309__auto___63245 = arguments.length;
var i__45310__auto___63246 = (0);
while(true){
if((i__45310__auto___63246 < len__45309__auto___63245)){
args__45316__auto__.push((arguments[i__45310__auto___63246]));

var G__63247 = (i__45310__auto___63246 + (1));
i__45310__auto___63246 = G__63247;
continue;
} else {
}
break;
...
return devtools.formatters.state.update_current_state_BANG_.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__45317__auto__);
});
...
devtools.formatters.state.update_current_state_BANG_.cljs$lang$applyTo = (function (seq63243){
var G__63244 = cljs.core.first.call(null,seq63243);
var seq63243__$1 = cljs.core.next.call(null,seq63243);
return devtools.formatters.state.update_current_state_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__63244,seq63243__$1);
});
...
return (p1__63248_SHARP_ === object);
});})(history))
,history);
});
...
//# sourceMappingURL=state.js.map?rel=1476719766329